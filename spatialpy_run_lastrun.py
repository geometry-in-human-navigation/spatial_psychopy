...
expInfo = {'participant': '112', 'run': '00'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/taiping/Workspace/spatialfMRI/neuroimage/psychopy/spatialcross/spatialcross_run_lastrun.py',
...
for thisLoop_video in loop_videos:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if show_single_clip.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > show_single_clip.tStartRefresh + 300-frameTolerance:
                # keep track of stop time/frame for later

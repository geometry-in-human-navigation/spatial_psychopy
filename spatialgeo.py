...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/taiping/Workspace/statespace/neuroimage/psychopy/spatialgeometry/spatialgeo.py',
...
for thisLoop_screenshot in loop_screenshots:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if screenshots_img.status == STARTED:
            ...
            if tThisFlipGlobal > screenshots_img.tStartRefresh + 1.0-frameTolerance:
...
for thisLoop_town in loop_town:
    ...
    for thisLoop_weather in loop_weather:
        ...
        for thisLoop_single_video in loop_single_video:
            ...
            show_current_town_weather.setText("Town:"+str(town_name)+",Weather:"+str(weather_name))
            # keep track of which components have finished
            show_exp_videosComponents = [show_single_video, image_question_for_know_or_not, key_question_for_know_or_not, show_current_town_weather]
            ...
            while continueRoutine:
                ...
                if image_question_for_know_or_not.status == NOT_STARTED and tThisFlip >= video_duration-frameTolerance:
                    # keep track of start time/frame for later
                ...
                waitOnFlip = False
                if key_question_for_know_or_not.status == NOT_STARTED and tThisFlip >= video_duration-frameTolerance:
                    # keep track of start time/frame for later

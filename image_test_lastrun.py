...
expName = 'image_test'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/taiping/Workspace/statespace/neuroimage/psychopy/spatialgeometry/image_test_lastrun.py',
...
left_image = visual.ImageStim(
    win=win,
    name='left_image', 
    image='/Users/taiping/Workspace/statespace/neuroimage/psychopy/spatialgeometry/media/Town01_ClearNoon/0_4_qestion1.jpg', mask=None,
...
trialComponents = [left_image, right_image]
...
thisExp.addData('left_image.started', left_image.tStartRefresh)
thisExp.addData('left_image.stopped', left_image.tStopRefresh)
thisExp.addData('right_image.started', right_image.tStartRefresh)
thisExp.addData('right_image.stopped', right_image.tStopRefresh)

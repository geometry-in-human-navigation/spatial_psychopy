...
function loop_instruction_rLoopBegin(loop_instruction_rLoopScheduler, snapshot) {
  return async function() {
    ...
    loop_instruction_r.forEach(function() {
...
function loop_questionsLoopBegin(loop_questionsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    loop_questions.forEach(function() {
...
function instruction_rRoutineBegin(snapshot) {
  return async function () {
    ...
    instruction_rComponents.forEach( function(thisComponent) {
...
function wait_for_startRoutineBegin(snapshot) {
  return async function () {
    ...
    wait_for_startComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function fix_cross_r_scanRoutineBegin(snapshot) {
  return async function () {
    ...
    fix_cross_r_scanComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function show_single_video_rRoutineBegin(snapshot) {
  return async function () {
    ...
    show_single_video_rComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function fix_cross_r_bqRoutineBegin(snapshot) {
  return async function () {
    ...
    fix_cross_r_bqComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function q_rRoutineBegin(snapshot) {
  return async function () {
    ...
    q_rComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function a_rRoutineBegin(snapshot) {
  return async function () {
    ...
    a_rComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function fix_cross_r_iqRoutineBegin(snapshot) {
  return async function () {
    ...
    fix_cross_r_iqComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function fix_cross_r_aqRoutineBegin(snapshot) {
  return async function () {
    ...
    fix_cross_r_aqComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;

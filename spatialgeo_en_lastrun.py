...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Volumes/StateSpace/research_backup/Postdoc_Times/UTokyoPostdoc/CompNeuro/3 Projects/spatialnavigation/decisionmaking/neuroimage/psychopy/spatialgeometry/spatialgeo_en_lastrun.py',
